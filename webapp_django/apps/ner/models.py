"""
Models do app NER — Experimentos de treinamento e resultados.

Migrado de webapp_django.apps.experiments.models preservando os
mesmos db_table para não exigir migration destrutiva no PostgreSQL.

Para migrar: python manage.py migrate --fake-initial ner
"""
...
class Experiment(models.Model):
    ...
    class Meta:
        db_table = "experiment"        # mantém tabela existente no PostgreSQL
...
class ExperimentResult(models.Model):
    ...
    class Meta:
        db_table = "experiment_result"  # mantém tabela existente no PostgreSQL
